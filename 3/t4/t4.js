...
function getClosestRestaurants(restaurants) {
  return getUserLocation().then((userLocation) => {
    return restaurants
      .map((restaurant) => {
        const distance = Math.sqrt(
          (restaurant.location.coordinates[0] - userLocation.lng) ** 2 +
          (restaurant.location.coordinates[1] - userLocation.lat) ** 2
        );
...
console.log(getClosestRestaurants(restaurants));

getClosestRestaurants(restaurants).then((closestRestaurants) => {
